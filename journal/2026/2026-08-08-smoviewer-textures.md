...
|---:|---|---:|---:|---:|
| `0x32E3` | BGRA | `+0x24` | `+0x28` | `+0x3D` |
| `0x43E3` | BGRA | `+0x24` | `+0x28` | `+0x3D` |
...
> Исправление от 14.08.2026. Байт `+0x3C` у `0x32E3`/`0x43E3` является
> обязательным marker `00` сериализатора, а не первым компонентом texel. Старое
> чтение ABGR от `+0x3C` случайно сохраняло RGB, но сдвигало Alpha на один pixel.
