# Свет, частицы и эффекты

Свет, fog и частицы связаны со сценой, мировыми преобразованиями и проходами renderer. Параметры ресурса и вычисления во время кадра рассматриваются раздельно.
...
- [Точность преобразования ориентации света на PC](light-corpus.md).
