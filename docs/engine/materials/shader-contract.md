...
Точные выражения Ballistic, порог loop, десятичный коэффициент `0.166667f`,
четырёхмерное расстояние и границы point size описаны в
[контракте баллистического шейдера](../effects/ballistic-shader.md).
...
Деформация позиции и нормали, порядок палитры и использование всех записанных
весов описаны отдельно в [контракте Skin](../animation/skin-deformation.md).
