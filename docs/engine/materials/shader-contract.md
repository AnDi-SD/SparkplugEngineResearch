...
реализует преобразование нормали в пространство камеры, ветвь directional
без specular и режимы цвета 0–7. Это семантическая реконструкция выражений
ресурса; она не является найденным CPU-методом игры. Point, spot и specular
не входят в этот интерфейс.
...
отдельные границы. При неизвестном режиме, числе directional больше восьми,
неконечных данных или нулевой нормали интерфейс отказывает без изменения выхода.
