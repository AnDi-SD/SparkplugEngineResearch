...
Общие исходники: [spBaseObject](../../../Sparkplug/Code/SparkBase/spBaseObject.h), [spDebugManager](../../../Sparkplug/Code/Sparkplug/spDebugManager.h).
...
Доказательства и границы — [animation lifecycle](../../engine/animation/animation-lifecycle.md).
