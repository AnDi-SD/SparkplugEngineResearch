...
Общие исходники: [spMaterialData](../../../Sparkplug/Code/Sparkplug/spMaterialData.h).
...
PS2 physical count больше unique count из-за повторов одних и тех же SMO в PCK; статистика вариантов считается по unique-ресурсам.
...
| 4 | `material.layer` | `UInt32` class ID | в известных данных `0x234C576B spStdLayer` |
...
| Набор | PS2 |
| --- | ---: |
| 11 material render states | 55 |
| 9 texture states | 15 |
| material color block | 27 |
