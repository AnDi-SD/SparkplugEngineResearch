# Нативный класс `spTextureBuffer`
...
| Registration / initializer | `0x00760938 / 0x006D3CD0` | `0x004A9A30 / 0x00482DD0` |
| Factory / constructor | `0x00475DF0 / 0x00475E00` (частично защищены) | `0x00173FC0 / 0x00173EA0` |
| Destructor | `0x00475EC0` | deleting `0x00173E00` |
| Clone / registration getter | `0x00475E70 / 0x00475DE0` | `0x00173F00 / 0x00173C80` |
| `Init` | `0x00475F30` | `0x00173C90` |
| Vtable | `0x006E94DC` | header `0x0048EBB0` |
