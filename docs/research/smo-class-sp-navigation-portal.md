# Полный разбор `spNavigationPortal`

## Результат

`spNavigationPortal` (`0x385662AA`) полностью разобран для чтения на PC и PS2.
Строгий decoder проверил 209 объектов: 70 в `pc-working`, 70 в
