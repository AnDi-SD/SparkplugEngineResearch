# `spPS2ErrorManager`: пустой PS2 presentation leaf
...
| Registration / initializer | `0x004B8730` / `0x004859B0` |
| Primary / support vtable | `0x00491E60` / `0x00491E84` |
| Getter | `0x0020DA20` |
| Destructor / support thunk | `0x0020D9B0` / `0x0020DC20` |
| Clone | `0x0020DA60` |
| Factory / direct create | `0x0020DBB0` / `0x0020DB40` |
...
Добавлены `Sparkplug/Code/SparkplugPS2/spPS2ErrorManager.h/.cpp`, exact leaf
layout/addresses и test common stack dispatch через пустой callback. Тесты
проходят 2/2.
