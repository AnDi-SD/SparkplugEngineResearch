# Полный разбор `spMeshNavigationSet`

## Результат

`spMeshNavigationSet` (`0x7297173C`) полностью разобран для чтения на PC и PS2.
Строгий decoder повторно прочитал все 355 экземпляров из трёх корпусов:
