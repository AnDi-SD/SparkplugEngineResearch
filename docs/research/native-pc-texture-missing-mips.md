...
В CP108 файл используется как точный срез объекта. Следующий отдельный
[CP109](native-pc-whole-textured-scene.md) закрывает whole loading.smo при тех же
заявленных consumer inputs.
