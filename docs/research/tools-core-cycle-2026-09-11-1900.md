...
Исследование и разработка остановлены: 2026-09-11 18:58:33 МСК. Далее — сохранение итогового commit и отчёта.

Завершён 21 пакет. Выбранные операции всех семи потребителей проверены; все ядра ещё не готовы. Следующая очередь: rigid lighting, material export/import, нужные операции LVL. Последний functional checkpoint root 9559a49, Viewer 3b332d4; native DLL соответствует финальному evidence. Заключительная сверка: 273 локальные ссылки и 24 выбранных исходных файла/зависимости, без расхождений. Публичная отправка остаётся остановленной прежним automatic approval review.
