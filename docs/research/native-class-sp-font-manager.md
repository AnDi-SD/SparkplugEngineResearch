...
Следующий [проверенный участок выбора материала/атласа](tool-text-gpu-2026-09-11.md)
подключён к общему GPU consumer. Text может использовать собственный material;
выбор fallback не подменяет его параметры.
...
| Registration | `0x0075DCC8` | `0x004B9430` |
| Initializer | `0x006D2780` | `0x00482960` |
| Primary/support vtables | `0x006DC424 / 0x006DC420` | `0x0048E5D0 / 0x0048E5F4` |
