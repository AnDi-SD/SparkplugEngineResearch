...
> **Исторический срез на 9 сентября, 19:00 МСК.** Таблица и очередь ниже
> сохранены как состояние того цикла: spatial, Light/BV, Font/Text metadata
> и другие пункты уже продвинулись. Для текущей работы использовать
> [статус на 10 сентября](tools-core-migration-status-2026-09-10.md) и
> [журнал продолжающегося цикла](tools-core-cycle-2026-09-10-0730.md).
