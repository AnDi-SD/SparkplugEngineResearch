...
[CP136: очередь](docs/research/tool-readiness-queue-2026-09-08.md) связана с
готовностью операций: закрытые срезы не предлагаются повторно, потеря актуального
подтверждения возвращает связанные задачи на проверку.
