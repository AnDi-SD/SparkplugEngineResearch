...
Текущий checkpoint: **15/16 (93,75% фиксированного списка)**. После
...
Проверка полного импорта выявила неподтверждённые material runs и rigid-детали
в skinned-пути: `import.skin` временно снят с готовности до исправления.
Исторический пик16/16 сохранён в предыдущих snapshots.
