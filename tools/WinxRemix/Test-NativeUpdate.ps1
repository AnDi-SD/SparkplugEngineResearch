...
$files=@('tools/WinxRemix/winx_native_update_source.h','tools/WinxRemix/test_native_update.cpp','tools/WinxRemix/Test-NativeUpdate.ps1','Sparkplug/Analysis/PC/SparkplugAbi.h','Sparkplug/Analysis/PC/SparkBaseAbi.h')
$manifest=@()
...
$source=Join-Path $build 'source/tools/WinxRemix/test_native_update.cpp'
$commands=@"
@echo off
