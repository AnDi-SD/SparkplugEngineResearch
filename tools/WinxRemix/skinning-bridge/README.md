...
```powershell
./tools/WinxRemix/skinning-bridge/Test-Skinning.ps1 -Name cpu-v1
./tools/WinxRemix/direct-camera-bridge/Test-Camera.ps1 -Name skinwire-camera-v1
./tools/WinxRemix/skinning-bridge/Build-Pair.ps1 -Name pair-v2 -TestName cpu-v1
python -B tools/WinxRemix/skinning-bridge/Capture-Manifest.py --tests cpu-v1 --build pair-v2
```
