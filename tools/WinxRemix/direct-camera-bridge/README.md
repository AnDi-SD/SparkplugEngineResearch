...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File tools/WinxRemix/direct-camera-bridge/Prepare-Bridge.ps1 -InitializeDetours
```
...
powershell -NoProfile -ExecutionPolicy Bypass -File tools/WinxRemix/direct-camera-bridge/Build-Bridge.ps1 -Platform x86 -Workers 1
powershell -NoProfile -ExecutionPolicy Bypass -File tools/WinxRemix/direct-camera-bridge/Build-Bridge.ps1 -Platform x64 -Workers 1
powershell -NoProfile -ExecutionPolicy Bypass -File tools/WinxRemix/direct-camera-bridge/Test-Camera.ps1
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File tools/WinxRemix/direct-camera-bridge/Prepare-Live.ps1 -Name runtime-new
python -B tools/WinxRemix/direct-camera-bridge/Run-Live.py --template runtime-new --name positive-new
python -B tools/WinxRemix/direct-camera-bridge/Run-Live.py --template runtime-new --name fault-new --fault
```
