...
if ($RunChecks) {
    & $cmake --build $taskBuild --target ViewerAnimationKeyChecks ViewerAnimationRuntimeChecks ViewerNodeWorldChecks ViewerTransformInputChecks ViewerSanReaderChecks --parallel 2
