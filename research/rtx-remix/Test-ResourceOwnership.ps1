...
cl /nologo /std:c++17 /EHsc /MT /O2 /W4 /I"$include" "$newSource" /Fe:test_resource_ownership.exe /link user32.lib
if errorlevel 1 exit /b %errorlevel%
cl /nologo /std:c++17 /EHsc /MT /O2 /W4 /I"$include" "$pressureSource" /Fe:test_surface_resources.exe /link user32.lib
exit /b %errorlevel%
"@
