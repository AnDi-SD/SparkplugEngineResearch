...
class Ps2ScalarPrefix:
    ...
    def __init__(self,ranges):
        ...
        self.u.ctl_set_cpu_model(registers.UC_CPU_MIPS64_R4000)
    ...
    def run(self,entry,stops,*,count=2000,timeout_us=100000):
        ...
        def interrupt(u,number,user):raise RuntimeError(f'No PS2 interrupt forwarding {number}')
        ...
        return dict(entry=f'{entry:08X}',stop=f'{self.stop:08X}',instructions=len(self.trace),
