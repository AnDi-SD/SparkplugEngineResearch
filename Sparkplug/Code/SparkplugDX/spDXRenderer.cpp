...
#include "spPCTextureStateMapping.h"
#include "spPCMaterialStateMapping.h"
...
namespace sparkplug::reconstruction
{
    ...
    {
        return ApplyPCMaterialStateSetForAnalysis(raw,material,overrides,lighting,dispatch,context);
    }
    ...
    {
        return ApplyPCRenderStateCacheEntryForAnalysis(cachedEntry,index,value,submit,context);
    }
    ...
    {
        return ApplyPCMaterialRenderStateForAnalysis(cached,index,value,dispatch,context,lighting);
    }
    ...
    {
        return ApplyPCMaterialColorSourceForAnalysis(rawSource,ambient,value,dispatch,context);
    }
    ...
    {
        return ApplyPCMaterialLightingForAnalysis(state,mode,dispatch,context);
    }
    ...
    {
        return ApplyPCTextureStateForAnalysis(cache,stage,index,value,overrideCoordinates,submit,context);
    }
} // namespace sparkplug::reconstruction
