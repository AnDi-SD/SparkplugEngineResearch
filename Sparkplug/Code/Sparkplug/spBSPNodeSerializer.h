...
// TU path inferred (no original source filename found).
#include "spPartitionNodeSerializer.h"
namespace sparkplug::reconstruction
{
    class spBSPNode;
    class spBSPNodeSerializer : public spPartitionNodeSerializer
    {
    public:
        static constexpr spClassID ClassID=0x84ACA2BA;
